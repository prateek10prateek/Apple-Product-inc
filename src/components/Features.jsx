...
const Features = () => {
    ...
    useGSAP(() => {
        // Ensure animationProps and scrollProps are defined or remove them
        gsap.to('#exploreVideo', {
            ...
            scrollTrigger: {
                ...
                start: '-10% bottom',
                // Add any required scrollProps if needed
            },
            onComplete: () => {
                if (videoRef.current) {
        ...
        animateWithGsap('.g_text', { y: 0, opacity: 1, ease: 'power2.inOut', duration: 0.75 });
    }, []);
                        ...
                        <div className="feature-text-container">
                            <div className="flex-1 flex-center">
                                <p className="feature-text g_text">
                                    iPhone 15 Pro is {' '}
                                    <span>the first iPhone to feature an aerospace-grade
                                        titanium design</span>
